...
const GurgaonEnvironmentalDashboard = () => {
  ...
  return (
    <div className="bg-black text-white flex items-center justify-center p-8">
      <div className="w-full max-w-7xl border-4 p-8 shadow-[0_0_20px_rgba(34,197,94,0.5)]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Temperature Graph */}
          <div className="bg-gray-900 rounded-2xl shadow-2xl p-8 border-2 border-gray-800 text-center transform transition-all hover:scale-105 col-span-2">
